...
export default {
  ...
  async asyncData ({ store, route }) {
    return store.dispatch('apps/GET_ARTICLE_APP',
      {
  ...
  computed: {
    ...mapState(['website', 'apps']),
    count () {
      return this.$store.state.apps.app.total
    },
    subscribeCount () {
      return this.$store.state.articleTag.tag.subscribe_count
    },
    tag () {
      return this.$store.state.apps.app
    },
    app () {
      return this.$store.state.apps.app.app
    },
    articleList () {
      return this.$store.state.apps.app.list
    },
  },
  components: {
    ArticleItem,
