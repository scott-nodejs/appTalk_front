<template>
  <div class="tag client-card">
    <div class="info-box">
      ...
      <router-link :to='{name:"app_detail",params:{appid:articleTagItem.id}}'>
        <div class="thumb">
          <img v-lazy="articleTagItem.url"
               class="box-image"
               alt="">
        </div>
        <div class="title"
      ...
      <div class="meta-box">
        <div class="meta article">
          {{articleTagItem.articleCount}} 篇文章
        </div>
    ...
    <div class="action-box"
      ...
      <!--</button>-->
      <button @click="subscribeTag"
              class="subscribe-btn not-subscribe">APP详情
      </button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    subscribeTag () { // 订阅标签
        this.$router.push({ name: 'app-desc', params: { apps_id: this.articleTagItem.id} })
    }
  },
  computed: {
    userArticleTag () {
