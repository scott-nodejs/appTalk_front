  ...
  methods: {
        ...
        this.$store
            ...
            observable.subscribe({
                ...
                complete: (result) => {
                    ...
                    this.$refs.mavonEditor.$img2Url(pos, cdnUrl + result.key)
                }
            })
        })
    ...
    saveArticle () {
      var params = {
        ...
        htmlUrl : marked(this.write.content, { breaks: true }) /*主内容*/,
      ...
      this.$store
        ...
        .then(res => {
          if (res.status === 200) {
            ...
            this.$router.push({
              name: 'user',
              params: { uid: this.personalInfo.user.id, routeType: 'article' }
            })
          } else {
