<template>
  <div class="comment-item"
       ...
       ref="comment_list">
    <div class="avatar">
      <img v-lazy="commentItem.user.photo"
           class="box-image"
           alt="">
    </div>
    <div class="comment-body">
      <div class="comment-main">
        <h4>
          <router-link class="user-info"
                       :to="{name:'user',params:{uid:commentItem.user.id,routeType:'article'}}">{{commentItem.user.nickname}}</router-link>
        </h4>
      ...
      <div class="comment-foot clearfix">
        ...
        <span class="comment-delete"
              v-if="personalInfo.user.id===commentItem.userId"
      ...
      <div class="comment-form-view"
        ...
        <comment-form :reply_uid="commentItem.userId"
