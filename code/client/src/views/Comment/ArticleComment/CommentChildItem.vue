<template>
  <div class="comment-item"
    ...
    <div class="avatar">
      <img v-lazy="childCommentItem.user.photo"
           class="box-image"
           alt="">
    </div>
      ...
      <div class="comment-main">
        <h4>
          <router-link class="user-info"
                       :to="{name:'user',params:{uid:childCommentItem.user.id,routeType:'article'}}">{{childCommentItem.user.nickname}}</router-link>
          <template v-if="childCommentItem.replyUser">
            <i class="middle-text">回复</i>
            <router-link class="user-info"
                         :to="{name:'user',params:{uid:childCommentItem.replyUser.id,routeType:'article'}}">{{childCommentItem.replyUser.nickname}}</router-link>
          </template>
        </h4>
