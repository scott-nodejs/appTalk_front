  ...
  <article class="content-box content-box-index">
    <div class="info-box">
      ...
      <div class="operat-view"
           v-if="personalInfo.islogin&&personalInfo.user.id===user.user.id">
        <Dropdown>
          ...
          <div class="dropdown-menu-view">
            <div class="dropdown-menu-item"
                 @click="commandChange({name:'Write',params:{type:articleItem.id}})">
              修改
            </div>
            <div class="dropdown-menu-item"
      ...
      <div class="info-row meta-row">
        <ul class="meta-list">
          ...
          <li class="item item-icon like-article">
            ...
            <strong v-text="articleItem.enshrineCount"></strong>
          </li>
          ...
          <li class="item"
              v-text="articleItem.dateString"></li>
          <li class="item"
          ...
          this.$store
            ...
            .then(result => {
              if(result.status === 200){
                  this.$message.success(result.massage);
