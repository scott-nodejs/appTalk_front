        ...
        <div class="col-xs-12 col-sm-9 col-md-9">
              ...
              <div class="info">
                <div class="title-line">
                  ...
                  <!--<span class="attention"-->
                        ...
                        <!--@click="collectBooks(apps.appsInfo.id)"-->
                ...
                <div class="other">
                  <!--<button class="btn button-look" click="lookChapter"> 关注 </button>-->
          ...
          <div class="client-card">
            ...
            <div class="book-content">
              ...
              <AppInfo v-show="currentType==='AppInfo'" />
              <AppComment v-show="currentType==='AppComment'" />
            </div>
          </div>
        </div>
...
import BookList from './component/AppList'
import AppInfo from './component/AppInfo'
import AppComment from './component/AppComment'
...
export default {
  ...
  metaInfo () {
    return {
      title: this.apps.appsInfo.name || "",
      // titleTemplate: `%s - ${this.website.meta.website_name || ''}`,
      meta: [
        {
          // set meta
          name: "description",
          content: `${this.apps.appsInfo.name || ""}`
        },
        {
          // og:site_name
        ...
        },
        {
          // og:site_name
          property: "og:image",
          content: this.apps.appsInfo.url || this.website.meta.logo
        },
        {
          // og:type
          property: "og:type",
        ...
        },
        {
          ...
          content: this.apps.appsInfo.description
        },
        {
          // og:url
          property: "og:url",
  ...
  asyncData ({ store, route, accessToken = '' }) {
    ...
    return Promise.all([
      store.dispatch("apps/GET_APPS_INFO", { apps_id: route.params.apps_id, type: 'look', accessToken }),
    ]);
  },
  mounted () {
  ...
  computed: {
    ...mapState(['apps', 'personalInfo', 'website'])
  },
  components: {
    // websiteNotice,
    // AppList,
