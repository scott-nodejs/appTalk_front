                        ...
                        <template v-if="personalInfo.islogin">
                            ...
                            <li class="nav-item"
                                ...
                                <router-link class="btn btn-sm no-read-msg"
                                    ...
                                    <span v-if="user.attentionMessageCount > 0"
                                          class="unread-message-count">{{user.attentionMessageCount}}</span>
                                </router-link>
                            </li>
                            <li class="nav-item"
                                v-if="personalInfo.islogin">
                                <router-link class="btn btn-sm no-read-msg"
                                             :to="{
                                                name: 'user',
                                                params: { uid: personalInfo.user.id, routeType: 'message' }
                                              }">
                                ...
                                <Dropdown placement="right">
                                    <div class="el-dropdown-link"
                                        ...
                                        <div class="avatar-img">
                                            <img v-lazy="personalInfo.user.photo"
                                                 class="box-image"
                                                 alt="" />
                                        </div>
                                    </div>
